...
def helix(r0, r_eps, p, h, inset=0, frac=1e-1):
    def func(t):
        ...
        if t <= frac:
            ...
            r = r0 + r_eps * s
            # print(
            #     f"helix.func:+ {helixCount}: t={t} a={degrees(a)} s={s} z={z} r={r} FIRST {t} <= {frac}"
            # )
            ...
            r = r0 + r_eps * s
            # print(
            #     f"helix.func:+ {helixCount}: t={t} a={degrees(a)} s={s} z={z} r={r} MIDDLE {t} > {frac} and {t} < {1 - frac}"
            # )
        else:
            ...
            r = r0 - r_eps * s
            # print(
            #     f"helix.func:+ {helixCount}: t={t} a={degrees(a)} s={s} z={z} r={r} LAST {t} >= {1 - frac}"
            # )
